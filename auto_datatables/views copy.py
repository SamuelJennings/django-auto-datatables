...
class DataTableBaseView(generics.ListAPIView):
    ...
    def get_serializer_class(self):
        ...
        return serializer_factory(model=self.model, fields=self.fields, base_class=self.base_serializer_class)
    ...
    def get_row_template(self):
        ...
        if self.row_template_name:
            template = get_template(self.row_template_name)
            # pprint.pprint(dir(template.template))
            # pprint.pprint(template.template.render(Context()))
            return render_to_string(self.row_template_name, context=context, request=self.request)
        return ""
